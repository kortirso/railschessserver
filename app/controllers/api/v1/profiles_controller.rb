class Api::V1::ProfilesController < Api::V1::BaseController
    ...
    api :GET, '/v1/profiles/me.json&token=TOKEN', 'Returns the information about the currently logged user'
    param :token, String, desc: 'Token info', required: true
    ...
    api :GET, '/v1/profiles/all.json&token=TOKEN', 'Returns the information about all users except currently logged user'
    param :token, String, desc: 'Token info', required: true
    error code: 401, desc: 'Unauthorized'
