class Turn < ActiveRecord::Base
    ...
    def self.build(game_id, from, to, second_from = '0', second_to = '0')
        ...
        cell_from = game.board.cells.find_by(x_param: from[0], y_param: from[1])
        cell_to = game.board.cells.find_by(x_param: to[0], y_param: to[1])
        ...
        game.board.check_beaten_fields
        game.beat_fields
        game.checkmat_check
        new_turn
    end
